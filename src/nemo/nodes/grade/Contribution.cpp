...
NodeDescriptor gradeDescriptor() {
    ...
    auto mix = mixParameterSpec("Grade");
    mix.editor = "nemo.numeric.graduated";
...
NodeContribution gradeContribution() {
    ...
    contribution.editors = {NodeEditorContribution{.id = "nemo.channels.rgb",
                                                   ...
                                                   .consumes = {}},
                            NodeEditorContribution{.id = "nemo.numeric.graduated",
                                                   .source = "qrc:/qt/qml/Nemo/qml/GraduatedNumberEditor.qml",
                                                   .consumes = {}}};
    return contribution;
}
